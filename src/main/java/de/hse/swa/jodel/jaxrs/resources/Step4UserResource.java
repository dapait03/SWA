...
public class Step4UserResource {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Contract addToContractList(@PathParam("contID") Long contID, @PathParam("contractStartDate") java.sql.Date contractStartDate, @PathParam("contractEndDate") java.sql.Date contractEndDate, @PathParam("contractIp1") String contractIp1, @PathParam("contractIp2") String contractIp2, @PathParam("contractIp3") String contractIp3, @PathParam("contractVersion") String contractVersion, @PathParam("contractNumFeature1") int contractNumFeature1, @PathParam("contractNumFeature2") int contractNumFeature2, @PathParam("contractNumFeature3") int contractNumFeature3, @PathParam("contractUser1") String contractUser1, @PathParam("contractUser2") String contractUser2, @PathParam("contractLicenseKey") String contractLicenseKey ) {
        Contract contractTemp = new Contract(contID, contractStartDate, contractEndDate, contractIp1, contractIp2, contractIp3, contractVersion, contractNumFeature1, contractNumFeature2, contractNumFeature3, contractUser1, contractUser2, contractLicenseKey);
